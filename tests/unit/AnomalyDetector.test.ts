...
import { AnomalyDetector, AnomalyReport } from '../../src/regression/AnomalyDetector';
import { ContentDiff } from '../../src/regression/ContentComparator';
...
describe('AnomalyDetector', () => {
    ...
    describe('detect()', () => {
        ...
        it('should detect table deletion', () => {
            const diff = createEmptyDiff();
            diff.tables.removed = [
                { name: 'Users Table', headers: ['ID', 'Name'], rowCount: 10 }
            ];
        ...
        it('should return WARNING severity when score >= 40', () => {
            ...
            diff.tables.removed = [
                { name: 'Data Table', headers: ['A', 'B'], rowCount: 5 }
            ];
