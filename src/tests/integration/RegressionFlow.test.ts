...
import { ContentComparator } from '../../regression/ContentComparator.js';
import { PageContent } from '../../regression/ContentExtractor.js';
import { BaselineManager } from '../../regression/BaselineManager.js';
import { VisualComparator } from '../../regression/VisualComparator.js';
import { AnomalyDetector } from '../../regression/AnomalyDetector.js';
import { BaselineIndex } from '../../regression/types.js';
...
describe('Regression Testing Integration', () => {
    ...
    describe('Full Regression Flow: Critical Changes (FAIL)', () => {
        it('should fail when critical buttons are removed', () => {
            ...
            expect(anomalyReport.issues.some((i: any) => i.type === 'CRITICAL_BUTTON_REMOVED')).toBe(true);
        });
        ...
        it('should fail when required input fields are removed', () => {
            ...
            expect(anomalyReport.issues.some((i: any) => i.type === 'REQUIRED_FIELD_MISSING')).toBe(true);
        ...
        it('should fail when table is deleted', () => {
            ...
            expect(anomalyReport.issues.some((i: any) => i.type === 'TABLE_DELETED')).toBe(true);
    ...
    describe('Full Regression Flow: Table Structure Changes', () => {
        it('should detect column removal in tables', () => {
            ...
            expect(anomalyReport.issues.some((i: any) => i.type === 'COLUMN_REMOVED')).toBe(true);
        });
